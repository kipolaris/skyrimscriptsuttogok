...
/**
    ...
    public GamePanel_old(GameEngine gameEngine, RoomController roomController) {

        JFrame doorViewFrame = new JFrame("Logarlec");
        doorView = new DoorView(doorViewFrame);
        // Set layout
...
/**
    ...
    public static void main(String[] args) {
        // Instantiate your GameEngine and RoomController here. For the sake of this example, I am just going to use null.
        GameEngine gameEngine = null;
        RoomController roomController = null;

        // Now create your GamePanel instance inside Event Dispatch Thread
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Game Panel");
            GamePanel_old gamePanel = new GamePanel_old(gameEngine, roomController);
            frame.add(gamePanel);
