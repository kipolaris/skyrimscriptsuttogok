...
public class MergeRooms implements iCommand {
    ...
    public void execute(String[] cmd) {
        if (cmd.length < 3) {
            gameEngine.getSuttogo().error("Invalid command. Please provide the IDs of the two rooms to be merged.");
            return;
        }
        ...
        if (room1 == null || room2 == null) {
            gameEngine.getSuttogo().error("One or both rooms not found!");
        }
